...
- **2026-07-25** — RFC 3161 timestamping is split into protocol validation and
  ...
  and optional trust-root verification. It returns raw validated token DER;
  settings and the PAdES-T unsigned CMS attribute remain the next integration.
...
- **RFC 3161 PAdES timestamping** — protocol client complete 2026-07-25;
  application settings and `signatureTimeStampToken` CMS/PAdES-T embedding
  remain. The audit-trail half of this roadmap item, `audit_events`, is done.
