...
- **2026-07-25** — RFC 3161 timestamping is split into protocol validation and
  ...
  slot reserves 32 KiB for TSA chains. Settings and export wiring remain.
...
- **RFC 3161 PAdES timestamping** — protocol client complete 2026-07-25;
  `signatureTimeStampToken` CMS/PAdES-T embedding and a DSS-classified
  `PAdES-BASELINE-T` fixture are complete. Application settings and export
  wiring remain. The audit-trail half of this roadmap item, `audit_events`, is
  done.
