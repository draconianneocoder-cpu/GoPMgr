...
<script lang="ts">
  ...
  // native-close guard uses) rather than `confirm()`: Wails v2.16.0's darwin
  // WKUIDelegate (WailsContext, in
  // github.com/wailsapp/wails/v2@v2.16.0/internal/frontend/desktop/darwin/
  ...
  // build, since Wails v2.16.0's darwin WKUIDelegate implements none of the
