...
<script lang="ts">
  ...
  const routeLoaders: Record<string, RouteLoader> = {
    ...
    charts: () => import('./lib/components/project/ChartFallback.svelte'),
    ...
    risk_matrix: () => import('./lib/components/charts/RiskMatrixEditor.svelte'),
    ...
    catalog: () => import('./lib/components/project/ProcurementCatalog.svelte'),
  ...
  const VIEW_LABELS: Record<string, string> = {
    ...
    catalog: 'Reusable suppliers and items',
    timeline: 'Timeline',
